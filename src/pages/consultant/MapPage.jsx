...
export default function MapPage() {
  ...
  useEffect(() => {
    ...
    // location markers
    if (layers.locations) {
      markersRef.current.locations = data.locations.map(l => {
              ...
              <div className="mlp-detail-body">
                ...
                <div className="mlp-detail-row">
                  ...
                  <span className="mlp-badge"
                    style={{ background: STATUS_COLORS[selectedDemande.status] + "22",
                ...
                <div className="mlp-detail-row">
                  ...
                  <span className="mlp-badge"
                    style={{ background: PRIORITY_COLORS[selectedDemande.priority] + "22",
